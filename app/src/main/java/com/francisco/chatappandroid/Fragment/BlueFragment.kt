package com.francisco.chatappandroid.Fragment
...
import kotlinx.android.synthetic.main.fragment_red.btnPlus
...
class BlueFragment : Fragment() {
    ...
    private var listener: AccionesFragmentos? = null


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        btnPlus.setOnClickListener { listener?.onClickFragment() }
    }
    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is AccionesFragmentos) {
            listener = context
        }
    }
